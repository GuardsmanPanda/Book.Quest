    ...
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <nav class="flex-1 px-2 bg-gray-800 space-y-1" aria-label="Sidebar">
          ...
          Narrator Home
            ...
            @include('layout.component.menu-item', ['title' => 'Find Narrators', 'url' => '/book/find', 'icon' => 'clipboard'])
            @include('layout.component.menu-item', ['title' => 'Random Narrator', 'url' => '/book/random', 'icon' => 'clipboard'])
        </nav>
    </div>
        ...
        <div class="bg-gray-700 p-2">
            <a href="#" class="flex-shrink-0 w-full group block p-2">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-white">Narrators</p>
                        <p class="text-xs font-medium text-gray-300 group-hover:text-gray-200">Listened To</p>
                    </div>
                </div>
            </a>
        </div>
