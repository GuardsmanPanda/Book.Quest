    ...
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <nav class="flex-1 px-2 bg-gray-800 space-y-1" aria-label="Sidebar">
          ...
          Series Home
            ...
            @include('layout.component.menu-item', ['title' => 'Find A Series', 'url' => '/book/find', 'icon' => 'clipboard'])
            @include('layout.component.menu-item', ['title' => 'Random Series', 'url' => '/book/random', 'icon' => 'clipboard'])
        </nav>
    </div>
    <div class="flex-shrink-0 flex flex-col gap-2">
        @if(\Infrastructure\Auth\Service\Auth::hasPermission('series__create'))
            @include('layout.component.menu-button', ['text' => 'Add Series', 'url' => '/series/create/dialog'])
        @endif
        <div class="bg-gray-700 p-2">
            <a href="#" class="flex-shrink-0 w-full group block p-2">
                <div class="flex items-center">
                    ...
                    <p class="text-green-400 font-medium text-3xl">372</p>
                    <div class="ml-3">
                        <p class="text-sm font-medium text-white">Series</p>
                        <p class="text-xs font-medium text-gray-300 group-hover:text-gray-200">Esxperienced</p>
                    </div>
                </div>
            </a>
        </div>
