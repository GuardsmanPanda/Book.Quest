<x-dialog.create-resource endpoint="/narrator/create" title="Add Narrator">
    <div class="flex flex-col gap-8 pb-4">
        <div>
            ...
            <input type="url" name="wikipedia_uri" id="wikipedia_uri"
                   ...
                   placeholder="https://en.wikipedia.org/wiki/..." pattern="https://en.wikipedia.org/wiki/.+"
                   size="60"/>
        </div>
    ...
    <datalist id="countries">
        @foreach(\Domain\App\Model\Country::orderBy('country_name')->get() as $country)
    ...
    <datalist id="languages">
        @foreach(\Domain\App\Model\Language::orderBy('language_name')->get() as $lang)
