<div hx-target="this" hx-swap="outerHTML">
    ...
    @else
        <button type="button" @if(\Infrastructure\Auth\Service\Auth::id() === null)  onclick="dialog('/login/login-selector-dialog')" @else hx-patch="/author/{{$author_id }}/user-status" hx-vals='{"status":"FOLLOW", "_token":"{{ csrf_token() }}"}' @endif
