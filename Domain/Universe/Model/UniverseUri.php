 ...
 * @method static Builder|UniverseUri with(array  $relations)
 ...
 * @method static Builder|UniverseUri whereIn(string $column, array $values, string $boolean = 'and', bool $not = false)
 * @method static Builder|UniverseUri whereHas(string $relation, Closure $callback, string $operator = '>=', int $count = 1)
 * @method static Builder|UniverseUri whereNull(string|array $columns, string $boolean = 'and')
 * @method static Builder|UniverseUri whereNotNull(string|array $columns, string $boolean = 'and')
